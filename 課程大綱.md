...
> **目標**：讓你的電腦準備好開發，理解工具是什麼、為什麼需要它。

### 章節列表
- `0-1` 開發環境全景圖：你需要安裝哪些東西，以及為什麼
...
| E-9-3 單元測試入門 | Part 2-8 CLI 小專案 | 寫完第一個完整函式後 |
...
| V5 | Part 5 完成後 | SQLite + Prisma | 真實資料庫，資料持久化 |
| V6 | Part 6 完成後 | React | 元件化前端 |
| V7 | Part 7 完成後 | Docker + Vercel + Railway | 部署上線，全世界可以看到 |
