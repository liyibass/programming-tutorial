...
> 想深入「後端 API 該怎麼設計錯誤處理」的完整原則，這是後端 Clean Code 的重要主題 → [課外讀物 E-6-3：函式設計](../../課外讀物/E-6-best-practices/E-6-3-function-design.md)
...
> 想完整理解 API 錯誤處理的設計原則（純函式、單一職責怎麼讓錯誤處理更乾淨）→ [課外讀物 E-6-3：函式設計](../../課外讀物/E-6-best-practices/E-6-3-function-design.md)
